...
const envContent = `# Websocket Signaling Service Environment Variables
NODE_ENV=development
PORT=3003
DB_HOST=localhost
DB_PORT=5432
DB_NAME=websocket_signaling_service
DB_USER=postgres
...
if (!fs.existsSync('package.json')) {
  const packageJson = {
    name: 'websocket-signaling-service',
    version: '1.0.0',
    description: 'WebSocket signaling service for real-time communication',
    main: 'src/server.js',
    scripts: {
    ...
    keywords: ['websocket', 'real-time', 'signaling', 'social-platform'],
...
console.log('\\n✓ Websocket Signaling Service setup completed!');

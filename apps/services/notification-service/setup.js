...
const envContent = `# Notification Service Environment Variables
...
if (!fs.existsSync('package.json')) {
  const packageJson = {
    ...
    version: '1.0.0',
    description: 'Notification service for the social platform',
    main: 'src/server.js',
    scripts: {
    ...
    keywords: ['notification', 'push', 'email', 'social-platform'],
...
.vscode/
.idea/
# Firebase credentials (should be added to version control in production)
...
console.log('\\n✓ Notification Service setup completed!');

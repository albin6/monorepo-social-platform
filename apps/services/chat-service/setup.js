...
const envContent = `# Chat Service Environment Variables
...
MESSAGE_ENCRYPTION_KEY=32_character_encryption_key_here
`;
...
if (!fs.existsSync('package.json')) {
  const packageJson = {
    ...
    keywords: ['chat', 'messaging', 'real-time', 'social-platform'],

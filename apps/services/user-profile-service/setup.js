...
const envContent = `# User Profile Service Environment Variables
...
if (!fs.existsSync('package.json')) {
  const packageJson = {
    ...
    version: '1.0.0',
    description: 'User profile service for social platform',
    main: 'src/server.js',
    scripts: {
    ...
    keywords: ['profile', 'user', 'social-platform'],
...
console.log('\\n✓ User Profile Service setup completed!');
